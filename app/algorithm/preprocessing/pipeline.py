...
def get_preprocess_pipeline(pp_params, model_cfg):
    ...
    pipe_steps.append(
        ...
        (
            ...
            preprocessors.StringTypeCaster(cat_vars=pp_params["cat_vars"]),
        )
    )
        ...
        pipe_steps.append(
            (
                ...
                preprocessors.ColumnSelector(
                    columns=pp_params["cat_vars"], selector_type="drop"
                ),
            )
        )
    ...
    if len(pp_params["num_vars"]):
        ...
        pipe_steps.append(
            (
                ...
                preprocessors.MinMaxBounder(cols_list=pp_params["num_vars"]),
            )
        )
